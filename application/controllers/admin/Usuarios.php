...
class Usuarios extends CI_Controller {
	...
	public function inserir(){
		...
		$this->form_validation->set_rules('txt-email', 'E-mail','required|min_length[3]|valid_email');
		...
		$this->form_validation->set_rules('txt-confirmasenha', 'Confirma Senha','required|matches[txt-senha]');
