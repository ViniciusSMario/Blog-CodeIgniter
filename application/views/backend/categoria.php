					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<?php 
								if($publicado == 1){
									echo '<div class="alert alert-success"> Item publicado com sucesso! </div>';
								}
							...
							<div class="col-lg-12">
								<?php
									...
									foreach($categorias as $categoria){
										...
										$alterar = anchor(base_url('admin/categoria/alterar/'. md5($categoria->id)), '<i class="fa fa-refresh fa-fw">Alterar</i>');
